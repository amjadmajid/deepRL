...
class Env():
    ...
    def getState(self, scan, past_action):
        ...
        if min_range > min(scan_range) > 0: #if there is a collision
            done = True
    ...
    def setReward(self, state, done):
        ...
        #check if the robot state was the same 20 times in a row
    ...
    def reset(self):
        ...
        try:
            ...
            pass
        # self.goal_x=globals.x_coord
        # self.goal_y=globals.y_coord

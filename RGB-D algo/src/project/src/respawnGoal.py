...
class Respawn():
    def __init__(self):
        ...
        self.init_goal_x = globals.x_coord
        self.init_goal_y = globals.y_coord
    ...
    def getPosition(self, position_check=False, delete=False):
        ...
        if self.stage != 4:
            while position_check:
                # coord_sub1 = rospy.Subscriber('/findObjects', Object, self.coord1, queue_size = 1, buff_size = 2**24)
                ...
                self.goal_position.position.x = globals.x_coord
                self.goal_position.position.y = globals.y_coord
        else:
            while position_check:
                # coord_sub2 = rospy.Subscriber('/findObjects', Object, self.coord1, queue_size = 1, buff_size = 2**24)

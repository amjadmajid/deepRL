...
STATE_DIMENSION = 14
ACTION_DIMENSION = 2
ACTION_V_MAX = 1 #0.22 # m/s
ACTION_W_MAX = 4. #2. # rad/s
world = 'world_u'
...
class RunManager():
    ...
    def setCoord(self, model):
        ...
        #Do some sort of resetting based on the previous bool which would be a global variable (in the respawn function, put 0,0 the inital location of the robot which it would need to go to)
        #print('***\n-------- DONEEEEEEE ----------\n****')
        # if ep%20 == 0:

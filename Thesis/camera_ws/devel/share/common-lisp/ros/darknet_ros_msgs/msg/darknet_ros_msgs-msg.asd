...
(defsystem "darknet_ros_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "ComputeBox" :depends-on ("_package_ComputeBox"))
    (:file "_package_ComputeBox" :depends-on ("_package"))
    (:file "ComputeBoxes" :depends-on ("_package_ComputeBoxes"))
    (:file "_package_ComputeBoxes" :depends-on ("_package"))
